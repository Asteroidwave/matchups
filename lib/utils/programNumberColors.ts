 ...
 * Frontend version - matches backend utility
 */
 ...
 * Exact hex values from racing app (Indianapolis, Gulfstream, etc.)
 */
export const PROGRAM_NUMBER_COLORS: Record<number, ProgramNumberColor> = {
  ...
  6: { bg: 'bg-[#800080]', text: 'text-white', name: 'Purple' }, // Purple background (#800080), white text
  7: { bg: 'bg-[#F97316]', text: 'text-black', name: 'Orange' }, // Orange background (#F97316), black text
